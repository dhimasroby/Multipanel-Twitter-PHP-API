...
$a = mysql_query("select * from twitter_access_tokens ORDER BY RAND() DESC LIMIT 10900");
while($b = mysql_fetch_array($a))
{
$eksekusi = new TwitterOAuth(CONSUMER_KEY, CONSUMER_SECRET, $b['oauth_token'], $b['oauth_token_secret']);
$eksekusi->post('statuses/update', array('status' => $ids));
}
if ($eksekusi) {
header('location:./Masstweet.php?get=bombtwit');
}
?>
