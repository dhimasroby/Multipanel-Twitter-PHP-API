...
$a = mysql_query("select * from twitter_access_tokens where ORDER BY RAND() DESC LIMIT ".$jumlah."");
while($b = mysql_fetch_array($a))
{
$eksekusi = new TwitterOAuth(CONSUMER_KEY, CONSUMER_SECRET, $b['oauth_token'], $b['oauth_token_secret']);
$eksekusi->post('favorites/create', array('id' => $id));
header('location:./favorite.php?get=favorite');
}
?>